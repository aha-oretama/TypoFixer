...
public class ExtensionFilterTest {
    ...
    @Before
    public void setUp() {
        diffs.add(new Diff("src/test/java/jp/aha/oretama/typoChecker/service/filter/ExtensionFilterTest.java", null));
    ...
    public void filteringByOneReturnOneFileExtension() {
        ...
        assertEquals("src/test/java/jp/aha/oretama/typoChecker/service/filter/ExtensionFilterTest.java", diffs.get(0).getPath());
    }
